...
| Upload commands | [upload guide](../SDK_UPLOADS.md) | Bounded signed PUT part transport exists; source staging, durable upload state, orchestration and uncertain-outcome reconciliation remain. |
