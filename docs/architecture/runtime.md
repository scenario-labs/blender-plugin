...
| Upload commands | [upload guide](../SDK_UPLOADS.md) | Private source staging, signed PUT parts and durable SDK upload commands share the coordinator/workers. Public scoped inspection exposes saved progress and conservative recovery suggestions; production policy, JobSession forwarding, recovery UI and active entry-point wiring remain. |
