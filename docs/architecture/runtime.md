...
| Upload commands | [upload guide](../SDK_UPLOADS.md) | Bounded signed PUT parts and scoped durable upload claims exist; source staging, orchestration and authoritative uncertain-outcome reconciliation remain. |
