...
Failure reporting uses exact-title, paginated issue lookup; a second failure
comments on the same open OS issue. Reporting does not turn a failed job green.
