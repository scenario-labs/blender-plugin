---
{
  ...
  "evidence": {
    ...
    "limits": "Reviewed separation of offline docs/site commands from online discovery and publishing. Handbook typography retains the documented Google Fonts dependency. Local rendering and orchestration checks do not establish hosted release or Pages acceptance.",
    "sources": {
