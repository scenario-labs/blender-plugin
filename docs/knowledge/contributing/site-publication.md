...
{
  "type": "Evidence",
  "id": "contributing.site-publication",
  "title": "CONTRIBUTING.md: site-publication",
  ...
  "evidence": {
    ...
    "limits": "Reviewed separation of offline docs/site commands from online discovery and publishing. Handbook typography retains the documented Google Fonts dependency. Local rendering and orchestration checks do not establish hosted release or Pages acceptance. Bootstrap is restricted to the fixed pre-adoption manifest version and a nonempty historical snapshot, and is retired by release version advancement. A final post-provenance snapshot rejects newly published releases during verification.",
    "sources": {
...
# CONTRIBUTING.md: site-publication
